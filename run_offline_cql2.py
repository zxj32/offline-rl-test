...
flags.DEFINE_string('dataset_dir2', 'datasets', 'Directory containing an offline dataset.')
flags.DEFINE_string('dataset_dir3', 'datasets', 'Directory containing an offline dataset.')
